import svgPaths from "./svg-v8eilklx1v";
...
export default function NativeAreaLenDn() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Native area - Lên đơn">
