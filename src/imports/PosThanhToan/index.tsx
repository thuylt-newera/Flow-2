import svgPaths from "./svg-jdd3yg8tl7";
...
function ContentCustomerInfo() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[3.5px] relative shrink-0 w-full" data-name="[Content] Customer info">
...
function Title1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Title">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-none not-italic relative shrink-0 text-[31.5px] text-black tracking-[-0.7875px] whitespace-nowrap">Tóm tắt đơn</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-normal gap-[7px] items-center leading-[42px] not-italic relative shrink-0 text-[28px] text-black whitespace-nowrap" data-name="Label">
      <p className="font-['Inter:Regular',sans-serif] relative shrink-0">Tổng tiền hàng</p>
      <p className="font-['Inter:Regular','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0">∙</p>
      <p className="font-['Inter:Regular',sans-serif] relative shrink-0">20 sản phẩm</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center justify-between overflow-clip relative shrink-0 w-full" data-name="line">
      ...
      <div className="content-stretch flex gap-px items-center relative shrink-0" data-name="Currency">
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[42px] not-italic relative shrink-0 text-[28px] text-black text-center whitespace-nowrap">190.000</p>
        <CurrencyName />
      </div>
    </div>
  );
...
function Label1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Label">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[42px] not-italic relative shrink-0 text-[28px] text-black whitespace-nowrap">Khách phải trả</p>
    </div>
  );
}
...
function CurrencyName1() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Currency name">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[42px] not-italic relative shrink-0 text-[#dc2626] text-[18.060000000000002px] text-center whitespace-nowrap">₫</p>
    </div>
  );
}
...
function Line1() {
  return (
    <div className="content-stretch flex items-center justify-between overflow-clip relative shrink-0 w-full" data-name="line">
      <Label1 />
      <div className="content-stretch flex gap-px items-center relative shrink-0" data-name="Currency">
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[42px] not-italic relative shrink-0 text-[#dc2626] text-[28px] text-center whitespace-nowrap">175.000</p>
        <CurrencyName1 />
      </div>
    </div>
  );
...
function Summary1() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-center justify-center overflow-clip relative shrink-0 w-full" data-name="Summary">
      <Line />
      <Line1 />
    </div>
  );
...
function Summary() {
  return (
    <div className="content-stretch flex flex-col gap-[7px] items-start py-[42px] relative shrink-0 w-full" data-name="Summary">
...
function Title2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Title">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-none not-italic relative shrink-0 text-[31.5px] text-black tracking-[-0.7875px] whitespace-nowrap">Hình thức thanh toán</p>
    </div>
  );
}
...
function Summary2() {
  return (
    <div className="content-stretch flex gap-[28px] items-center justify-center overflow-clip pt-[7px] relative shrink-0 w-full" data-name="Summary">
      <div className="bg-[rgba(220,38,38,0.05)] flex-[1_0_0] min-w-[64px] relative rounded-[28px]" data-name="Payment method">
        <div className="flex flex-col items-center justify-center min-w-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[21px] items-center justify-center min-w-[inherit] p-[28px] relative size-full">
            <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[56px]" data-name="Icon Placeholder">
              <div className="flex-[1_0_0] min-h-px overflow-clip relative w-full" data-name="Lucide Icons / banknote">
                <div className="absolute inset-[20.84%_4.18%]" data-name="Vector">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 51.3208 32.6553">
                    <path d={svgPaths.p3e3544c0} fill="var(--fill-0, #DC2626)" id="Vector" />
                  </svg>
                </div>
              </div>
            </div>
            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[42px] min-w-full not-italic relative shrink-0 text-[#dc2626] text-[28px] text-center w-[min-content]">Trả ngay</p>
          </div>
        </div>
        <div aria-hidden className="absolute border-2 border-[#dc2626] border-solid inset-0 pointer-events-none rounded-[28px]" />
      </div>
      <div className="flex-[1_0_0] min-w-[64px] relative rounded-[28px]" data-name="Payment method">
        <div className="flex flex-col items-center justify-center min-w-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[21px] items-center justify-center min-w-[inherit] p-[28px] relative size-full">
            <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[56px]" data-name="Icon Placeholder">
              <div className="flex-[1_0_0] min-h-px overflow-clip relative w-full" data-name="Lucide Icons / book-text">
                <div className="absolute inset-[4.18%_12.51%]" data-name="Vector">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 41.9897 51.3208">
                    <path d={svgPaths.p10e36400} fill="var(--fill-0, black)" id="Vector" />
                  </svg>
                </div>
              </div>
            </div>
            <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[42px] min-w-full not-italic relative shrink-0 text-[28px] text-black text-center w-[min-content]">Ghi nợ</p>
          </div>
        </div>
...
function PaymentMethod() {
  return (
    <div className="content-stretch flex flex-col gap-[7px] items-start py-[42px] relative shrink-0 w-full" data-name="Payment method">
      <div aria-hidden className="absolute border-[#d4d4d8] border-solid border-t inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[21px] items-center min-h-[56px] relative shrink-0 w-full" data-name="Section header">
        <Title2 />
      </div>
    ...
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start px-[28px] relative size-full">
          <div className="content-stretch flex flex-col gap-[7px] items-start pb-[42px] pt-[28px] relative shrink-0 w-full" data-name="[Section] Customer info">
            <div className="content-stretch flex gap-[21px] items-center min-h-[56px] relative shrink-0 w-full" data-name="Section header">
              <Title />
      ...
      <div className="content-stretch flex gap-[28px] items-start p-[28px] relative size-full">
        ...
        <div className="flex-[1_0_0] h-[70px] min-w-px relative rounded-[14px] shadow-[0px_1px_2px_0px_rgba(26,26,26,0.05)]" style={{ backgroundImage: "linear-gradient(90deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.1) 100%), linear-gradient(90deg, rgb(220, 38, 38) 0%, rgb(220, 38, 38) 100%)" }} data-name="Brand Button">
          <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex gap-[14px] items-center justify-center px-[28px] relative size-full">
              <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[42px] not-italic relative shrink-0 text-[28px] text-white whitespace-nowrap">Hoàn tất đơn hàng</p>
            </div>
          </div>
        </div>
      </div>
...
function ContentOrder() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-start justify-end min-h-px overflow-clip relative rounded-bl-[28px] rounded-br-[28px] rounded-tr-[28px] w-full" data-name="[Content] Order">
      <Container1 />
      <div className="relative rounded-bl-[28px] rounded-br-[28px] shrink-0 w-[924px]" data-name="Bottom bar - Payment">
...
function NativeAreaThanhToan() {
  return (
    <div className="content-stretch flex flex-col items-start justify-self-stretch overflow-clip relative self-stretch shrink-0" data-name="Native area - Thanh toán">
...
export default function PosThanhToan() {
  return (
